  ...
  return (
    <section id="home">
      <style>{`
        ...
        #home {
          min-height: 100vh; padding: 0; color: #e8e4dc;
        ...
        .home-divider { height: 1px; background: rgba(255,255,255,0.06); margin: 0; }

        /* ── Hero ── */
        .home-hero {
          display: flex; flex-direction: column;
          gap: 24px; padding: 60px 60px 36px;
        }
        .home-hero-copy { display: flex; flex-direction: column; gap: 18px; }
        .home-eyebrow {
          font-family: 'JetBrains Mono', monospace; font-size: 12px;
          letter-spacing: 0.2em; text-transform: uppercase;
          color: var(--accent); display: inline-flex; align-items: center; gap: 10px;
        }
        .home-eyebrow::before { content: ''; width: 24px; height: 1px; background: var(--accent); display: inline-block; }
        .home-title {
          font-family: 'Bebas Neue', sans-serif; font-size: clamp(64px, 11vw, 130px);
          line-height: 0.9; color: #ffffff; letter-spacing: 0.02em;
        }
        .home-title .h-accent { color: var(--accent); }
        .home-description { font-size: 15px; line-height: 1.85; color: #c8c4bc; max-width: 560px; }
        .home-hero-actions { display: flex; flex-wrap: wrap; gap: 10px; margin-top: 4px; }
        .home-social-btn {
        ...
        /* ── Section ── */
        .home-section { padding: 28px 60px; }
        .home-section-head { display: flex; align-items: center; justify-content: space-between; gap: 12px; margin-bottom: 20px; }
        .home-section-title { font-family: 'Bebas Neue', sans-serif; font-size: 22px; color: #e8e4dc; line-height: 1; letter-spacing: 0.02em; }
        .home-section-right { display: flex; align-items: center; gap: 14px; flex-wrap: wrap; justify-content: flex-end; }
        .home-section-link {
          font-family: 'JetBrains Mono', monospace; font-size: 11px; letter-spacing: 0.1em;
          text-transform: uppercase; color: var(--accent); background: none; border: none;
          cursor: pointer; padding: 0; opacity: 0.8; transition: opacity 0.18s;
        }
        ...
        .carousel-btn {
          ...
          color: #6a6a72; display: flex; align-items: center; justify-content: center;
        ...
        .carousel-dot {
          width: 4px; height: 4px; border-radius: 50%; background: #2a2a32;
          border: none; cursor: pointer; padding: 0; transition: background 0.18s, transform 0.18s;
        }
        .carousel-dot.active { background: var(--accent); transform: scale(1.4); }

        /* ── Featured Blog — 3D Coverflow ── */
        .blog-coverflow {
          perspective: 1100px;
        ...
        .blog-carousel-card {
          ...
          display: flex; flex-direction: column; width: 313px;
        ...
        .hb-excerpt {
          font-size: 13px; color: #9a9890; line-height: 1.7; margin: 0; flex: 1;
        ...
        .hb-badge {
          ...
          padding: 4px 10px; background: rgba(var(--accent-rgb),0.09);
          border: 1px solid rgba(var(--accent-rgb),0.22);
          border-radius: 5px; color: var(--accent); flex-shrink: 0;
        }
        .blog-empty {
        ...
        /* ── Skills — polished animated lanes ── */
        .skill-rows {
          display: flex;
        ...
        .skill-lane-track {
          display: flex; gap: 8px; width: max-content; padding: 0 10px;
        ...
        .skill-icon-img { width: 15px; height: 15px; object-fit: contain; display: block; }
        .skill-icon-emoji { font-size: 14px; line-height: 1; }
        ...
        @media (max-width: 1024px) {
          ...
          .home-hero { padding: 28px 24px 24px; gap: 20px; }
          .home-section { padding: 22px 24px; }
          .skill-cat-label-col { width: 72px; }
          .blog-coverflow { height: 380px; }
        }
        ...
        @media (max-width: 640px) {
          .home-title { font-size: clamp(48px, 12vw, 72px); }
          .home-hero { padding: 20px 16px; }
          .home-section { padding: 20px 16px; }
          .home-section-right { gap: 8px; }
          .home-section-link { font-size: 10px; }
              ...
              {blogs.length > 1 && (
                <div className="carousel-dots">
                  {blogs.map((_, i) => (
                    <button
                      key={i}
                      className={`carousel-dot${i === blogIdx ? " active" : ""}`}
