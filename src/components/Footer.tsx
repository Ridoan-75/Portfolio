...
const socialLinks = [
  ...
  {
    label: "Twitter / X",
    href: "https://twitter.com/Ridoan_75",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
...
export default function Footer() {
  useEffect(() => {
    // autoAlpha handles both opacity AND visibility — no inline opacity:0 needed on the element
    gsap.fromTo(
      ".footer-content",
      { autoAlpha: 0, y: 40 },
      {
        ...
        scrollTrigger: {
          ...
          start: "top 95%", // earlier trigger so bottom-of-page footer isn't missed
  ...
  return (
    ...
    >
      <style>{`
        ...
        .footer-top-border {
          height: 1px;
          background: linear-gradient(90deg, transparent, rgba(200,240,96,.15), transparent);
        }

        /* NO opacity:0 here — GSAP autoAlpha sets visibility:hidden + opacity:0 itself */
        .footer-content {
          position: relative;
          z-index: 1;
          max-width: 1100px;
        ...
        .footer-logo .logo-accent { color: #c8f060; }
        ...
        .footer-link:hover::before { color: #c8f060; }
        ...
        .footer-built-dot {
          ...
          animation: ftBlink 2s ease infinite;
        }
      ...
      <div className="footer-content">
        <div className="footer-grid">
          ...
          <div>
            <a href="#home" className="footer-logo">
              <span className="logo-accent">R</span>idoan
            </a>
            <p className="footer-bio">
              Full Stack Developer &amp; UI/UX Designer. Crafting fast,
              scalable, pixel-perfect web experiences for global clients.
            </p>
          ...
          <div>
            ...
            <div className="footer-contact-item">
              ...
              <a href="mailto:hello@ridoan.dev" className="footer-contact-val">
                hello@ridoan.dev
              </a>
            </div>
            <div className="footer-contact-item">
              ...
              <span className="footer-contact-val">
                Bangladesh<br />Remote Worldwide
              </span>
            </div>
            <div className="footer-contact-item">
              <span className="footer-contact-icon">utc</span>
              <span className="footer-contact-val">
                UTC+6<br />Available Now
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <div className="footer-copy">
            © {new Date().getFullYear()} <span>Ridoan.</span> All rights reserved.
          </div>
